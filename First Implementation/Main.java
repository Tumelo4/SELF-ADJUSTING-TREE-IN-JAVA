public class Main {
    ...
    {
        Integer[] list = new Integer[]{80,32,110,15,43,87,140,7,20,35,50,83,90,120,160,7,9,29};
	...
	*/
        ...
        // stree.access(7, SplayTree.SplayType.SPLAY);
        // stree.printTree(true);
	...
	*/
        ...
        sstree.access(7, SplayTree.SplayType.SEMISPLAY);
        sstree.printTree(true);
